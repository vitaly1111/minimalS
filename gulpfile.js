...
//watch('./src/images/**.{jpg,jpeg,png,gif,webp}', imagesToApp);
function watching() {
...
/* 	browserSync.init({
	...
	watch('src/images/**/*.{jpg,jpeg,png,gif,webp,avif}', imagesToApp);
	
	watch(['src/images/**/*.svg','!app/images/svg','!src/images/svg/**/*'],imagesToApp),
...
exports.imagesToApp=imagesToApp;
exports.imagesToDist=imagesToDist;
...
exports.build=series(cleanDist,scriptsBuild,libCSSDist,stylesBuild,imagesToDist,images,build);
/* exports.default=parallel(htmlInclude,scripts,fonts,styles,browsersync,watching) */

exports.default=series(clean,parallel(htmlInclude,scripts,imagesToApp,svgSprites,resourcesToApp,fonts),libCSS,styles,parallel(browsersync,watchFiles))